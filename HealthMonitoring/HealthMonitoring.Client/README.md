...
Reusable .NET client for configuration-based service self-registration and dependency mapping.
...
Dependency mappings are resolved by `TargetServiceId` and are created or updated as needed.
